...
const navigation = [
    {
        name: 'GitHub',
        href: 'https://github.com/panda15963/BixPaymentAssignment',
...
export default function Footer() {
    return (
        <footer className="bg-white border-t border-gray-200 shadow-sm dark:bg-gray-900 dark:border-gray-800 dark:shadow-none">
